...
<?php  
	...
	***********************************************************/	
		...
		//Set Upload directory    
			$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/'.rootDir.'/assets/images/profile_pics';
		//Set File name	
            ...
            <div class="card shadow m-3">
                ...
                <div class="card-body">
                    ...
                    ?>
                        ...
                        <div id="CroppingContainer" style="min-width:800px; max-height:100%; background-color:#FFF;  overflow:hidden; border:2px #666 solid; z-index:2001; padding-bottom:0px;">  
                        
                            <div id="CroppingArea" style="width:500px; overflow:hidden; margin:40px 0px 40px 40px; border:2px #666 solid; float:left;">	
                                <img src="<?=$imgSrc?>" border="0" id="jcrop_target" style="border:0px #990000 solid; margin:0px 0px 0px 0px; padding:0px; " />
                            </div>  

                            <div id="InfoArea" style="width:180px; overflow:hidden; margin:40px 0px 0px 40px; border:0px #666 solid; float:left;">	
