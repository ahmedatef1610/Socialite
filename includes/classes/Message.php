    ...
    class Message {
        ...
        public function getMessages($otherUser) {
            ...
            while($row = mysqli_fetch_array($get_messages_query)) {
                ...
                if($user_to == $userLoggedIn):
                    $div ="<div class='message bg-info p-2 mb-3 float-left d-inline-block' id='green'>
                                $body 
                            </div><div class='clearfix'></div>";
                else:
                    $div ="<div class='message bg-light p-2 mb-3 mr-3 float-right d-inline-block' id='blue'>                                
                                $body 
                            </div><div class='clearfix'></div>";
                endif;
                ...
                $return_string .= "
                                    <div class='card shadow m-3'>
                                        <div class='row no-gutters'>
                                            <div class='col-4'>
                                                <a href='$username'>
                                                    <img src='{$user_found_obj->getProfilePic()}' class='card-img' alt='{$user_found_obj->getFirstAndLastName()}'>
                                                </a>
                                            </div>
                                            <div class='col-8'>
                                                <div class='card-body py-1'>
                                                    <a class='text-decoration-none' href='$username'>
                                                        <h5 class='card-text m-0'>{$user_found_obj->getFirstAndLastName()}</h5>
                                                    </a>
                                                    <p class='card-text m-0'>$latest_message_details[0] $split </p>
                                                    <p class='card-text m-0 text-muted'>$latest_message_details[2]</p>
                                                    <p class='card-text m-0 '><a href='messages.php?u=$username'>Go To Messages </a> </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        public function getConvosDropdown($data, $limit) {
            ...
            foreach($convos as $username) {
                ...
                $style = ($row['opened'] == 'no') ? "background-color: #777;" : "";
                ...
                <div class='dropdown-item' >
                    <div class='row'>
                        <div class='col-12'>
                            <div class='card shadow' style='$style'>
                                <div class='row no-gutters'>
                                    <div class='col-4'>
                                        <a href='$username'>
                                            <img src='{$user_found_obj->getProfilePic()}' class='card-img' alt='{$user_found_obj->getFirstAndLastName()}'>
