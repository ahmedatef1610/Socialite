                        ...
                        while($row = mysqli_fetch_array($usersReturnedQuery)) {
                            ...
                            if($user['username'] != $row['username']) {
                                ...
                                if($user_obj->isFriend($row['username']))
                                    $button = "<input type='submit' name='" . $row['username'] . "' class='btn btn-danger mb-2' value='Remove Friend'>";
                                else if($user_obj->didReceiveRequest($row['username']))
                                    $button = "<input type='submit' name='" . $row['username'] . "' class='btn btn-warning mb-2' value='Respond to request'>";
                                else if($user_obj->didSendRequest($row['username']))
                                    $button = "<input type='submit' class='default' value='Request Sent'>";
                                else 
                                    $button = "<input type='submit' name='" . $row['username'] . "' class='btn btn-success mb-2' value='Add Friend'>";
